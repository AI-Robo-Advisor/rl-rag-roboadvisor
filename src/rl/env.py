...
class PortfolioEnv(gym.Env):
    ...
    RAG 기반 리스크 태그 벡터(macro_rate_risk·equity_market_risk·geopolitical_fx_risk)를 관측공간에 포함합니다.
    """
    def __init__(
        self,
        returns_df,
        ...
        # RAG 리스크 태그 벡터: [macro_rate_risk, equity_market_risk, geopolitical_fx_risk] (shape=3)
